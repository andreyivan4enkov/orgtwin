...
0.8.2: тот же recipe agent_rules на BPIC2012 для сравнения с медлогами (бизнес vs медицина, один протокол).

Рецепт: `agent_rules`. Конфиг: `configs/experiments/v0.8.2.json`.
