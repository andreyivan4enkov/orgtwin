...
0.8.7: BPIC2012; исправлено исключение агент-идентификаторов (org:resource/org:group) при поиске changed Information-полей.

Рецепт: `agent_rules`. Конфиг: `configs/diagnostic/v0.8.7.json`.
