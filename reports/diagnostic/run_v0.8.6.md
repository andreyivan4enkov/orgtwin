...
0.8.6: Sepsis Cases; исправлено исключение агент-идентификаторов (org:resource/org:group) при поиске changed Information-полей.

Рецепт: `agent_rules`. Конфиг: `configs/diagnostic/v0.8.6.json`.
