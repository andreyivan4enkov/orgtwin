...
0.8.3: Hospital BPIC2011; directed edge semantics: какие Information-поля меняются перед hand-over (A→B).

Рецепт: `agent_rules`. Конфиг: `configs/diagnostic/v0.8.3.json`.
