...
0.8.1: Sepsis Cases (NL hospital ERP). 16 активностей, циклы ER→лаборатория→release. Агент=org:group, контекст=Age. Split 7+3 мес. Проверка гипотезы: детерминированный медлог → высокий next-step на holdout.

Рецепт: `agent_rules`. Конфиг: `configs/experiments/v0.8.1.json`.
...
- `A → C`: n=438, Pout=0.4011, Pin=0.8975, asym=-0.3989, H_from=2.3878
- `A → B`: n=401, Pout=0.3672, Pin=0.4402, asym=0.0135, H_from=2.3878
- `C → A`: n=392, Pout=0.8000, Pin=0.5513, asym=0.3989, H_from=0.9063
- `B → A`: n=307, Pout=0.3537, Pin=0.4318, asym=-0.0135, H_from=2.8828
- `B → E`: n=288, Pout=0.3318, Pin=0.7956, asym=0.3187, H_from=2.8828
- `E → ?`: n=151, Pout=0.9869, Pin=0.9934, asym=0.9869, H_from=0.1005
- `F → B`: n=78, Pout=0.8387, Pin=0.0856, asym=0.8007, H_from=0.7503
- `C → B`: n=65, Pout=0.1327, Pin=0.0714, asym=0.1119, H_from=0.9063
