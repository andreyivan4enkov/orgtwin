...
0.8.10: Hospital 2011; глобальная сводка мутаций Information по всем directed рёбрам (не только top-15).

Рецепт: `agent_rules`. Конфиг: `configs/diagnostic/v0.8.10.json`.
...
- `Nursing ward → General Lab Clinical Chemistry`: n=1144, Pout=0.5652, Pin=0.4460, asym=0.1858, H_from=2.4740, top_changed=Specialism code
- `General Lab Clinical Chemistry → Nursing ward`: n=977, Pout=0.3794, Pin=0.4759, asym=-0.1858, H_from=2.6549, top_changed=Specialism code
- `Medical Microbiology → General Lab Clinical Chemistry`: n=435, Pout=0.9932, Pin=0.1696, asym=0.8794, H_from=0.0699, top_changed=Producer code
- `General Lab Clinical Chemistry → Internal Specialisms clinic`: n=426, Pout=0.1654, Pin=0.7220, asym=-0.0258, H_from=2.6549, top_changed=Specialism code
- `Internal Specialisms clinic → Nursing ward`: n=377, Pout=0.6379, Pin=0.1836, asym=0.6147, H_from=1.6679, top_changed=Producer code
- `General Lab Clinical Chemistry → Obstetrics & Gynaecology clinic`: n=307, Pout=0.1192, Pin=0.3473, asym=-0.2098, H_from=2.6549, top_changed=Specialism code
- `Obstetrics & Gynaecology clinic → General Lab Clinical Chemistry`: n=305, Pout=0.3290, Pin=0.1189, asym=0.2098, H_from=2.6063, top_changed=Specialism code
- `General Lab Clinical Chemistry → Medical Microbiology`: n=293, Pout=0.1138, Pin=0.6689, asym=-0.8794, H_from=2.6549, top_changed=Producer code

## Мутации Information на всех рёбрах (fit)
Кандидатов полей: 123.  
Рёбер с мутацией: 184 / 184 (доля 1.0000).  
Handover с мутацией: 8582 / 8582 (доля 1.0000).  
Взвешенное среднее числа полей: 3.6741.  
Глобальный топ полей: `Producer code` (8582), `Activity code` (8201), `Specialism code` (7674), `Section` (6921), `Number of executions` (153).

Топ рёбер по mutation_mass (avg_n × n):
- `Nursing ward → General Lab Clinical Chemistry`: n=1144, avg_n=4.0498, mass=4633.0000, top=Specialism code
- `General Lab Clinical Chemistry → Nursing ward`: n=977, avg_n=4.0031, mass=3911.0000, top=Specialism code
- `General Lab Clinical Chemistry → Internal Specialisms clinic`: n=426, avg_n=4.0000, mass=1704.0000, top=Specialism code
- `Internal Specialisms clinic → Nursing ward`: n=377, avg_n=4.0133, mass=1513.0000, top=Producer code
- `General Lab Clinical Chemistry → Obstetrics & Gynaecology clinic`: n=307, avg_n=4.0033, mass=1229.0000, top=Specialism code
- `Obstetrics & Gynaecology clinic → General Lab Clinical Chemistry`: n=305, avg_n=4.0033, mass=1221.0000, top=Specialism code

По tertile handover_count:
- `low` (n=1…2): рёбер 61/61, доля=1.0000
- `mid` (n=2…10): рёбер 61/61, доля=1.0000
- `high` (n=11…1144): рёбер 62/62, доля=1.0000
