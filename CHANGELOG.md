...
#### Протестировано (holdout, raw) — тот же рецепт, что 0.6.0
| | Softmax | FEP habit_only | FEP full_efe |
|--|---------|----------------|--------------|
| next-step | 0.5504 | 0.5508 | 0.5484 |
| top-3 | 0.9112 | 0.9019 | 0.9056 |
| weekly_corr | 0.9216 | 0.8611 | 0.8610 |

Победитель next-step: **fep_habit_only**; weekly: **softmax**. Тег: `v0.7.0`.
...
next-step 胜者：**fep_habit_only**；weekly：**softmax**。标签：`v0.7.0`。
